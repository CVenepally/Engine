...
public:
	...
	virtual SoundID				CreateOrGetSound( const std::string& soundFilePath, FMOD_MODE soundMode = FMOD_DEFAULT );
	...
	void						UpdateListener(int listenerIndex, Vec3 const& soundPosition, Vec3 const& listernerForward, Vec3 const& listenerUp);
