...
//-------------------------------------------------------------------------------------------------------------------------------------------------------------------
EulerAngles::EulerAngles(std::vector<float> const& floatArray)
	:EulerAngles(0.f, 0.f, 0.f)
{
	if(floatArray.size() >= 3)
	{
		m_yawDegrees = floatArray[0];
		m_pitchDegrees = floatArray[1];
		m_rollDegrees = floatArray[2];
	}
}

//-------------------------------------------------------------------------------------------------------------------------------------------------------------------
EulerAngles::EulerAngles(std::vector<double> const& floatArray)
	:EulerAngles(0.f, 0.f, 0.f)
{
	if(floatArray.size() >= 3)
	{
		m_yawDegrees	= static_cast<float>(floatArray[0]);
		m_pitchDegrees	= static_cast<float>(floatArray[1]);
		m_rollDegrees	= static_cast<float>(floatArray[2]);
	}
}
