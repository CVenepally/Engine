...
struct Mat44
{
	...
	explicit Mat44(double const* sixteenValuesBasisMajor);
	...
	static Mat44 const MakeFromQuaternion(float x, float y, float z, float w);
	...
	void GetAsMat34(float out_Mat[3][4]);
