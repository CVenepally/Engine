...
//-------------------------------------------------------------------------------------------------------------------------------------------------------------------
void Rgba8::SetFromFloat(float* colorAsFloat)
{
	float red	= colorAsFloat[0];
	float green = colorAsFloat[1];
	float blue	= colorAsFloat[2];
	float alpha = colorAsFloat[3];

	r = static_cast<uchar>(RangeMapClamped(red,		0.f, 1.f, 0.f, 255.f));
	g = static_cast<uchar>(RangeMapClamped(green,	0.f, 1.f, 0.f, 255.f));
	b = static_cast<uchar>(RangeMapClamped(blue,	0.f, 1.f, 0.f, 255.f));
	a = static_cast<uchar>(RangeMapClamped(alpha,	0.f, 1.f, 0.f, 255.f));
}

//-------------------------------------------------------------------------------------------------------------------------------------------------------------------
void Rgba8::SetFromDouble(double* colorAsFloat)
{
	float red	= static_cast<float>(colorAsFloat[0]);
	float green = static_cast<float>(colorAsFloat[1]);
	float blue	= static_cast<float>(colorAsFloat[2]);
	float alpha = static_cast<float>(colorAsFloat[3]);
...
//------------------------------------------------------------------------------------------------------------------
Rgba8 const Rgba8::operator*(float uniformScale) const
{
	uchar red	= static_cast<uchar>(static_cast<float>(r) * uniformScale);
	uchar green = static_cast<uchar>(static_cast<float>(g) * uniformScale);
	uchar blue	= static_cast<uchar>(static_cast<float>(b) * uniformScale);
	uchar alpha = static_cast<uchar>(static_cast<float>(a) * uniformScale);
